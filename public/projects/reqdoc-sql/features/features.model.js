...
class FeatureModel extends sequelize_1.Model {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            const features = yield this.findAll({
                ...
                order: [
                    ...
                    [{ model: models_1.ReqModel, as: 'reqs' }, 'sort', 'ASC']
                ]
            });
    ...
    setCache(value) {
        return __awaiter(this, void 0, void 0, function* () {
            const project = yield models_1.ProjectModel.findByPk(this.projectId, {
                rejectOnEmpty: new Error('No project found for feature')
            });
            value.teamUserIds = yield models_1.TeamModel.getTeamMembers(project.teamId);
            yield (0, redis_1.setValue)('feature:featureId', value);
        });
    }
    clearCache() {
        return __awaiter(this, void 0, void 0, function* () {
            yield FeatureModel.clearCache(this.featureId);
        });
    }
    checkAccess(userId) {
        return __awaiter(this, void 0, void 0, function* () {
