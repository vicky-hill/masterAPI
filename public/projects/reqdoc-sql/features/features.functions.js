...
const getFeatureById = (featureId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    const cached = yield models_1.FeatureModel.getCache(featureId, userId);
    if (cached)
        return cached;
...
const createFeature = (_a, userId_1) => __awaiter(void 0, [_a, userId_1], void 0, function* ({ name, projectId }, userId) {
    ...
    yield models_1.ProjectModel.checkAccess(projectId, userId);
    const featureCount = yield models_1.FeatureModel.count({
        where: { projectId, parentId: null }
    });
    yield models_1.FeatureModel.create({
    ...
    const features = yield models_1.FeatureModel.getFeaturesByProjectId(projectId);
    return features;
});
...
const updateFeature = (data, featureId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const features = yield models_1.FeatureModel.getFeaturesByProjectId(feature.projectId);
    return features;
});
...
const createSubFeature = (data, featureId, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield models_1.FeatureModel.create(Object.assign(Object.assign({}, data), { projectId: Number(projectId), parentId: Number(featureId), sort: ((_a = mainFeature.subFeatures) === null || _a === void 0 ? void 0 : _a.length) || 0 }));
    const features = yield models_1.FeatureModel.getFeaturesByProjectId(projectId);
    return features;
});
