...
==================================== */
router.route('/admin').get(middleware_1.protect, verbs_controller_1.getAdminVerbs);
router.route('/admin').post(middleware_1.protect, verbs_controller_1.createVerb);
router.route('/admin/:verbId').delete(middleware_1.protect, verbs_controller_1.deleteVerb);
/* ====================================
   @ api/lesprit/verbs
==================================== */
// router.route('/').get(protect, getVerbs)
