...
exports.migrateFalseIdol = migrateFalseIdol;
...
function addForeignKey(queryInterface) {
    return __awaiter(this, void 0, void 0, function* () {
        yield queryInterface.addConstraint('userDrinks', {
            fields: ['userId'],
            type: 'foreign key',
            name: 'userDrinks_userId_fk',
            references: {
                table: 'users',
                field: 'userId'
            },
...
const addOrUpdateForeignKey = (tableName_1, columnName_1, referencedTable_1, referencedColumn_1, ...args_1) => __awaiter(void 0, [tableName_1, columnName_1, referencedTable_1, referencedColumn_1, ...args_1], void 0, function* (tableName, columnName, referencedTable, referencedColumn, onDelete = 'CASCADE', onUpdate = 'CASCADE') {
    ...
    const [constraints] = yield falseidol_db_config_1.default.query(`
    ...
    if (constraints.length === 0) {
        ...
        yield falseidol_db_config_1.default.query(`
...
const addCascadeConstraint = () => __awaiter(void 0, void 0, void 0, function* () {
    yield addOrUpdateForeignKey('profiles', 'userId', 'users', 'userId', 'CASCADE', 'CASCADE');
});
function migrateFalseIdol() {
    return addForeignKey(falseidol_db_config_1.default.getQueryInterface());
}
