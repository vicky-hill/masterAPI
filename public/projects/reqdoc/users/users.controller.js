...
const createUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { userId } = req.params;
        const user = yield User.createUser(req.body, userId);
        res.json(user);
    }
    catch (err) {
        next(err);
...
const inviteUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const result = yield User.inviteUser(req.body, userId);
        res.json(result);
    }
    catch (err) {
        next(err);
...
const updateUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield User.updateUser(req.body, userId, loggedInUserId);
        res.json(user);
    }
    catch (err) {
        next(err);
