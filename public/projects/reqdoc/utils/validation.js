...
const validate = {
    ...
    createProject: (values) => __awaiter(void 0, void 0, void 0, function* () { return yield validateStrings(values, "name team slug key"); }),
    updateProject: (values) => __awaiter(void 0, void 0, void 0, function* () { return yield validateStrings(values, "~name ~slug"); }),
