...
const validate = {
    sort,
    createReq: (values) => __awaiter(void 0, void 0, void 0, function* () { return yield validateStrings(values, "~title text featureId"); }),
    ...
    addComment: (values) => __awaiter(void 0, void 0, void 0, function* () { return yield validateStrings(values, "text"); }),
