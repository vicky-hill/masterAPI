...
const config = {
    ...
    db: {
        username: (_d = process.env.DB_SANDBOX_USERNAME) !== null && _d !== void 0 ? _d : '',
        password: (_e = process.env.DB_SANDBOX_PASSWORD) !== null && _e !== void 0 ? _e : '',
        dbName: (_f = process.env.DB_SANDBOX_NAME) !== null && _f !== void 0 ? _f : '',
        details: {
            host: (_g = process.env.DB_SANDBOX_HOST) !== null && _g !== void 0 ? _g : '',
            dialect: 'mysql',
