...
const reqdoc_users = require('./projects/reqdoc/users/users.routes')
const reqdoc_teams = require('./projects/reqdoc/teams/teams.routes')
const reqdoc_admin = require('./projects/reqdoc/admin/admin.routes')
...
const snapplist_placeRoutes = require('./projects/snapplist/places/places.routes')

const hotkeysnippets_noteRoutes = require('./projects/hotkey/notes/notes.routes')
